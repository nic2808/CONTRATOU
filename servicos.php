...
<section class="services-content">
    <div class="container">
            ...
            <div class="service-card" data-category="manutencao" data-location="zona-norte" data-price="120">
                ...
                <div class="service-content">
                    ...
                    <div class="service-details">
                        ...
                        <span class="location"><i class="fas fa-map-marker-alt"></i> Zona Norte</span>
                    </div>
                    <button class="btn btn-primary btn-full">Contratar Serviço</button>
                </div>
            </div>
            ...
            <div class="service-card" data-category="reformas" data-location="zona-sul" data-price="200">
                ...
                <div class="service-content">
                    ...
                    <div class="service-details">
                        ...
                        <span class="location"><i class="fas fa-map-marker-alt"></i> Zona Sul</span>
                    </div>
                    <button class="btn btn-primary btn-full">Contratar Serviço</button>
                </div>
            </div>
            ...
            <div class="service-card" data-category="automotivo" data-location="zona-oeste" data-price="150">
                ...
                <div class="service-content">
                    ...
                    <div class="service-details">
                        ...
                        <span class="location"><i class="fas fa-map-marker-alt"></i> Zona Oeste</span>
                    </div>
                    <button class="btn btn-primary btn-full">Contratar Serviço</button>
                </div>
            </div>
            ...
            <div class="service-card" data-category="beleza" data-location="zona-leste" data-price="40">
                ...
                <div class="service-content">
                    ...
                    <div class="service-details">
                        ...
                        <span class="location"><i class="fas fa-map-marker-alt"></i> Zona Leste</span>
                    </div>
                    <button class="btn btn-primary btn-full">Contratar Serviço</button>
                </div>
            </div>
        ...
        <div class="load-more">
            <button class="btn btn-secondary">Carregar Mais Serviços</button>
        </div>
    </div>
</section>
